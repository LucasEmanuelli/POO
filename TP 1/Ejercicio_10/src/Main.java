    ...
    public static void main(String[] args) {
        ...
        while (opciones != 0) {
            ...
            if (opciones == 1) {
                ...
                fecTarea = sc.next();
                System.out.print("Ingrese la fecha recordatorio de la tarea a agregar (yy-mm-dd):");
                fecRecTarea = sc.next();
                listaTarea.agregar(descTarea, prioTarea, estTarea, fecTarea, fecRecTarea);
